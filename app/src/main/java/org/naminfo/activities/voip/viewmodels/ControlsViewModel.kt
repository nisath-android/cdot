 ...
 */
package org.naminfo.activities.voip.viewmodels
...
class ControlsViewModel : ViewModel() {
    ...
    // private var allPbxContacts: List<PbxContact> = emptyList()

   /* fun fetchPbxContacts() {
        // val authInfo = coreContext.core

        FetchPbxContactsTask { contacts ->
            allPbxContacts = contacts
        }.execute()
    }*/
    ...
    private val listener: CoreListenerStub = object : CoreListenerStub() {
        override fun onCallStateChanged(
            ...
            if (state == Call.State.End) {
                ...
                /*// Extract the phone numbers from PBX contacts
                // val pbxNumbers = allPbxContacts.map { it.extensionNumber } // Replace phoneNumber with the actual field

                // Update direction to PBX if the from or remote address matches any PBX number
                if (fromAddress in pbxNumbers || remoteAddress in pbxNumbers) {
                    Log.i("[Call Controls] PBX number detected, updating direction to PBX")
                    direction = "PBX"
                    callTypes = "1"
                }*/
                ...
                /*if (direction == "Outgoing" || direction == "PBX") {
                    //sendCdrUsingGetRequest(cdrDetails)
                }*/
            }

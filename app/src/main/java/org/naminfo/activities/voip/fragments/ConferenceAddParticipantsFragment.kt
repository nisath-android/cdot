...
import org.naminfo.activities.voip.viewmodels.ConferenceParticipantsViewModel
import org.naminfo.activities.voip.viewmodels.ConferenceParticipantsViewModelFactory
import org.naminfo.activities.voip.viewmodels.ConferenceViewModel
import org.naminfo.contact.ContactsSelectionAdapter
import org.naminfo.databinding.VoipConferenceParticipantsAddFragmentBinding
...
class ConferenceAddParticipantsFragment : GenericFragment<VoipConferenceParticipantsAddFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.contactsList.observe(
            ...
            android.util.Log.d("[xxxAdapter]", "16--> ${it.size}")
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == 0) {
            ...
            if (granted) {
                ...
                Log.i("[Contacts-ConferenceAddPartFrag] READ_CONTACTS permission granted")

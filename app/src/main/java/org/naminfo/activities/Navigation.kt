...
import org.naminfo.activities.assistant.fragments.*
import org.naminfo.activities.main.MainActivity
import org.naminfo.activities.main.about.AboutFragment
import org.naminfo.activities.main.chat.fragments.ChatRoomCreationFragment
import org.naminfo.activities.main.chat.fragments.DetailChatRoomFragment
import org.naminfo.activities.main.chat.fragments.GroupInfoFragment
import org.naminfo.activities.main.chat.fragments.MasterChatRoomsFragment
import org.naminfo.activities.main.conference.fragments.*
import org.naminfo.activities.main.contact.fragments.DetailContactFragment
import org.naminfo.activities.main.contact.fragments.MasterContactsFragment
import org.naminfo.activities.main.dialer.fragments.DialerFragment
import org.naminfo.activities.main.fragments.TabsFragment
import org.naminfo.activities.main.history.fragments.DetailCallLogFragment
import org.naminfo.activities.main.history.fragments.MasterCallLogsFragment
import org.naminfo.activities.main.settings.fragments.*
import org.naminfo.activities.main.sidemenu.fragments.SideMenuFragment
import org.naminfo.activities.voip.CallActivity
import org.naminfo.activities.voip.fragments.*
...
/*
internal fun MasterContactsFragment.navigateToContact(sipContact: ContactsListViewModel.SipContact) {
    if (findNavController().currentDestination?.id == R.id.masterContactsFragment) {
        val navHostFragment =
            childFragmentManager.findFragmentById(R.id.contacts_nav_container) as NavHostFragment

        val bundle = Bundle().apply {
            // putString("id", sipContact.id) // Pass the unique ID or other details
            putString("name", sipContact.name)
            putString("number", sipContact.mobileNumber)
            // Add other required properties of SipContact as needed
        }
...
internal fun SideMenuFragment.navigateToAbout() {
    findNavController().navigate(
        ...
        null,
        popupTo(R.id.aboutFragment, false)
    )
}
...
internal fun AboutFragment.navigateToHlp() {
    findNavController().navigate(
        R.id.action_aboutFragment_to_helpFragment
    )
}
...
internal fun IncomingCallFragment.navigateToActiveCall() {
    Log.i("[Navigation-IncomingCallFragment-singleCallFragment]")
    findNavController().navigate(
        R.id.action_global_singleCallFragment,
        null,
...
internal fun SingleCallFragment.navigateToCallsList() {
    Log.i("[Navigation-SingleCallFragment-callsListFragment]")
...
internal fun SingleCallFragment.navigateToConferenceParticipants() {
    Log.i("[Navigation-SingleCallFragment-conferenceParticipantsFragment]")
    if (findNavController().currentDestination?.id == R.id.singleCallFragment) {
        findNavController().navigate(
...
internal fun SingleCallFragment.navigateToConferenceLayout() {
    Log.i("[Navigation-SingleCallFragment-conferenceLayoutFragment]")
    if (findNavController().currentDestination?.id == R.id.singleCallFragment) {
        findNavController().navigate(
...
internal fun SingleCallFragment.navigateToIncomingCall() {
    Log.i("[Navigation-SingleCallFragment-globalIncomingCallFragment]")
    if (findNavController().currentDestination?.id == R.id.singleCallFragment) {
        findNavController().navigate(
            R.id.action_global_incomingCallFragment,
            null,
...
internal fun ConferenceCallFragment.navigateToCallsList() {
    Log.i("[Navigation-ConferenceCallFragment-callsListFragment]")
...
internal fun ConferenceCallFragment.navigateToConferenceParticipants() {
    Log.i("[Navigation-ConferenceCallFragment-conferenceParticipantsFragment]")
    if (findNavController().currentDestination?.id == R.id.conferenceCallFragment) {
        findNavController().navigate(
...
internal fun ConferenceCallFragment.navigateToConferenceLayout() {
    Log.i("[Navigation-ConferenceCallFragment-conferenceLayoutFragment]")
    if (findNavController().currentDestination?.id == R.id.conferenceCallFragment) {
        findNavController().navigate(
...
internal fun ConferenceCallFragment.refreshConferenceFragment() {
    Log.i("[Navigation-ConferenceCallFragment-conferenceCallFragment]")
    if (findNavController().currentDestination?.id == R.id.conferenceCallFragment) {
        findNavController().navigate(
            R.id.action_global_conferenceCallFragment,
            null,
...
internal fun ConferenceParticipantsFragment.navigateToAddParticipants() {
    Log.i("[Navigation-AddParticipants]")
...
internal fun WelcomeFragment.navigateToEmailAccountCreation() {
    Log.i("[Navigation-EmailAccountCreation]")
...
internal fun WelcomeFragment.navigateToPhoneAccountCreation() {
    Log.i("[Navigation-PhoneAccountCreation]")
    if (findNavController().currentDestination?.id == R.id.welcomeFragment) {
        findNavController().navigate(
...
internal fun WelcomeFragment.navigateToNoPushWarning() {
    Log.i("[Navigation-NoPushWarning]")
    if (findNavController().currentDestination?.id == R.id.welcomeFragment) {
        findNavController().navigate(
...
internal fun WelcomeFragment.navigateToRemoteProvisioning() {
    Log.i("[Navigation-RemoteProvision]")
    if (findNavController().currentDestination?.id == R.id.welcomeFragment) {
        findNavController().navigate(

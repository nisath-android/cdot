 ...
 */
package org.naminfo.activities.chat_bubble
...
import org.naminfo.activities.main.chat.viewmodels.*
import org.naminfo.activities.main.viewmodels.ListTopBarViewModel
import org.naminfo.databinding.ChatBubbleActivityBinding
...
class ChatBubbleActivity : GenericActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        listViewModel.events.observe(
            ...
            android.util.Log.d("[xxxAdapter]", "2--> ${events.size}")

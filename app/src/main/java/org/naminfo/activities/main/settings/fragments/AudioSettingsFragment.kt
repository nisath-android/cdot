...
import org.naminfo.activities.main.settings.viewmodels.AudioSettingsViewModel
import org.naminfo.databinding.SettingsAudioFragmentBinding
...
class AudioSettingsFragment : GenericSettingFragment<SettingsAudioFragmentBinding>() {
    ...
    private fun initAudioCodecsList() {
        ...
        for (payload in coreContext.core.audioPayloadTypes) {
            ...
            binding.setVariable(org.naminfo.BR.title, payload.mimeType)

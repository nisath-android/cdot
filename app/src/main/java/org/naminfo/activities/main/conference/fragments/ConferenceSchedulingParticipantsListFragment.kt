 ...
 */
package org.naminfo.activities.main.conference.fragments
...
import org.naminfo.activities.main.conference.viewmodels.ConferenceSchedulingViewModel
import org.naminfo.activities.navigateToSummary
import org.naminfo.contact.ContactsSelectionAdapter
import org.naminfo.databinding.ConferenceSchedulingParticipantsListFragmentBinding
...
class ConferenceSchedulingParticipantsListFragment : GenericFragment<ConferenceSchedulingParticipantsListFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.contactsList.observe(
            ...
            android.util.Log.d("[xxxAdapter]", "7--> ${it.size}")
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == 0) {
            ...
            if (granted) {
                ...
                Log.i("[Contacts-LoaderManager] READ_CONTACTS permission granted")

...
import org.naminfo.activities.main.conference.adapters.ScheduledConferencesAdapter
import org.naminfo.activities.main.conference.data.ScheduledConferenceData
import org.naminfo.activities.main.conference.viewmodels.ScheduledConferencesViewModel
...
import org.naminfo.databinding.ConferencesScheduledFragmentBinding
...
class ScheduledConferencesFragment : MasterFragment<ConferencesScheduledFragmentBinding, ScheduledConferencesAdapter>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listViewModel.conferences.observe(
            ...
            android.util.Log.d("[xxxAdapter]", "9--> ${it.size}")

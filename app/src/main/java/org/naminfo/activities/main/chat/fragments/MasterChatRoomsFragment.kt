...
import org.naminfo.activities.clearDisplayedChatRoom
import org.naminfo.activities.main.MainActivity
import org.naminfo.activities.main.chat.adapters.ChatRoomsListAdapter
import org.naminfo.activities.main.chat.viewmodels.ChatRoomsListViewModel
...
import org.naminfo.activities.navigateToChatRoomCreation
import org.naminfo.databinding.ChatRoomMasterFragmentBinding
...
class MasterChatRoomsFragment : MasterFragment<ChatRoomMasterFragmentBinding, ChatRoomsListAdapter>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listViewModel.chatRooms.observe(
            ...
            android.util.Log.d(
                "[xxxAdapter]",
                "6--> ${chatRooms.size},${chatRooms.forEach {
                    android.util.Log.d(
                        "[xxxAdapter]",
                        "name:${it.chatRoom.peerAddress.username}\n" +
                            "displayName:${it.chatRoom.peerAddress.displayName}"
                    )
                }}"
            )
        ...
        binding.setCreateChatRoomListener {
            Log.i("[Chat Room] Creating Chat Room")
            listViewModel.createChatRoom()
        }

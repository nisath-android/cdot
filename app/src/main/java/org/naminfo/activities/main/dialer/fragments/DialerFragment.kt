 ...
 */
package org.naminfo.activities.main.dialer.fragments
...
import org.naminfo.BuildConfig
...
import org.naminfo.activities.main.dialer.viewmodels.DialerViewModel
...
import org.naminfo.activities.navigateToConfigFileViewer
import org.naminfo.activities.navigateToContacts
import org.naminfo.compatibility.Compatibility
import org.naminfo.databinding.DialerFragmentBinding
...
class DialerFragment : SecureFragment<DialerFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.takePTT.observe(viewLifecycleOwner) {
            navigatePPTScreen()
        }
        checkForUpdate()
    ...
    private fun navigatePPTScreen() {
        if (binding.sipUriInput.text.trim().isEmpty()) {
            findNavController().navigate(R.id.action_dialerFragment_to_PTTFragment)
        } else {
            findNavController().navigate(R.id.action_dialerFragment_to_PTTVoiceFragment)
        }
    }

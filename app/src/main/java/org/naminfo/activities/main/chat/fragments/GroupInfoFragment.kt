...
import org.naminfo.activities.main.chat.GroupChatRoomMember
import org.naminfo.activities.main.chat.adapters.GroupInfoParticipantsAdapter
import org.naminfo.activities.main.chat.data.GroupInfoParticipantData
import org.naminfo.activities.main.chat.viewmodels.GroupInfoViewModel
import org.naminfo.activities.main.chat.viewmodels.GroupInfoViewModelFactory
...
import org.naminfo.databinding.ChatRoomGroupInfoFragmentBinding
...
class GroupInfoFragment : SecureFragment<ChatRoomGroupInfoFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.participants.observe(
            ...
            android.util.Log.d("[xxxAdapter]", "4--> ${it.size}")

 ...
 */
package org.naminfo.activities.main.recordings.fragments
...
import org.naminfo.activities.main.recordings.adapters.RecordingsListAdapter
import org.naminfo.activities.main.recordings.data.RecordingData
import org.naminfo.activities.main.recordings.viewmodels.RecordingsViewModel
import org.naminfo.databinding.RecordingsFragmentBinding
...
class RecordingsFragment : MasterFragment<RecordingsFragmentBinding, RecordingsListAdapter>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.recordingsList.observe(
            ...
            android.util.Log.d("[xxxAdapter]", "14--> ${recordings.size}")

 ...
 */
package org.naminfo.activities.main.dialer.viewmodels
...
import org.naminfo.activities.main.dialer.NumpadDigitListener
import org.naminfo.activities.main.viewmodels.LogsUploadViewModel
...
class DialerViewModel : LogsUploadViewModel() {
    ...
    private val listener = object : CoreListenerStub() {
        ...
        override fun onTransferStateChanged(core: Core, transfered: Call, callState: Call.State) {
            if (callState == Call.State.OutgoingProgress) {
                ...
                onMessageToNotifyEvent.value = Event(org.naminfo.R.string.dialer_transfer_succeded)
            }
        }
        ...
        /*override fun onVersionUpdateCheckResultReceived(
            ...
            super.onVersionUpdateCheckResultReceived(core, result, version, url)
    ...
    fun transferCallTo(addressToCall: String) {
        if (!coreContext.transferCallTo(addressToCall)) {
            onMessageToNotifyEvent.value = Event(org.naminfo.R.string.dialer_transfer_failed)
        }
    }

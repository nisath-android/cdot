...
class SipContactViewModelFactory(private val sipContact: SipContactViewModel.SipContact) : ViewModelProvider.NewInstanceFactory() {
...
class SipContactViewModel(sipContact: SipContact) : ViewModel() {
    ...
    var contact: MutableLiveData<SipContact> = MutableLiveData()

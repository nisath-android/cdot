...
import org.naminfo.activities.main.chat.adapters.ImdnAdapter
import org.naminfo.activities.main.chat.viewmodels.ImdnViewModel
import org.naminfo.activities.main.chat.viewmodels.ImdnViewModelFactory
import org.naminfo.activities.main.fragments.SecureFragment
import org.naminfo.databinding.ChatRoomImdnFragmentBinding
...
class ImdnFragment : SecureFragment<ChatRoomImdnFragmentBinding>() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        if (chatRoom == null) {
            Log.e("[######] Chat room is null, aborting!")
        ...
        viewModel.participants.observe(
            ...
            android.util.Log.d("[xxxAdapter]", "5--> ${it.size}")

...
class CorePreferences(private val context: Context) {
    ...
    var debugLogs: Boolean
        get() = config.getBool("app", "debug", org.naminfo.BuildConfig.DEBUG)
        set(value) {
    ...
    var showNewContactAccountDialog: Boolean
        get() = config.getBool("app", "show_new_contact_account_dialog", false)
        set(value) {
    ...
    var sendEarlyMedia: Boolean
        get() = config.getBool("sip", "outgoing_calls_early_media", true)
        set(value) {
    ...
    var pbxContactsSaved: String?
        get() = config.getString("app", "pbx_contacts_saved", null)
        set(value) {
            config.setString("app", "pbx_contacts_saved", value)
        }
    var groupContactsSaved: String?
        get() = config.getString("app", "group_contacts_saved", null)
        set(value) {
            config.setString("app", "group_contacts_saved", value)
        }
    var sipContactsSaved: String?
        get() = config.getString("app", "sip_contacts_saved", null)
        set(value) {
    ...
    var callType: String?
        ...
        set(value) {
            config.setString("app", "calltype_contacts_saved", value)
        }
    var getRemoteUserPhoneNumber: String?
        get() = config.getString("app", "remote_user_phone", null)
        set(value) {
            config.setString("app", "remote_user_phone", value)
        }
    var getCurrentUserPhoneNumber: String?
        get() = config.getString("app", "current_user_phone", null)
        set(value) {
            config.setString("app", "current_user_phone", value)
        }
    var getCurrentUserName: String?
        get() = config.getString("app", "current_user_name", null)
        set(value) {
            config.setString("app", "current_user_name", value)
        }
    var getCallerName: String?
        get() = config.getString("app", "caller_user_name", null)
        set(value) {
            config.setString("app", "caller_user_name", value)
        }
    var typeOfCall: String?
        get() = config.getString("app", "typeofcall", null)
        set(value) {
            config.setString("app", "typeofcall", value)
        }
    ...
    private fun copy(from: String, to: String, overrideIfExists: Boolean = false) {
        ...
        if (outFile.exists()) {
            if (!overrideIfExists) {
                android.util.Log.i(
                    context.getString(org.naminfo.R.string.app_name),

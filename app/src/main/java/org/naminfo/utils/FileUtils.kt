...
class FileUtils {
    ...
    companion object {
        ...
        fun getMimeType1(type: String?): Int {
            if (type.isNullOrEmpty()) return -1
            return when {
                type.startsWith("image/") -> 1
                type.startsWith("text/plain") -> 2
                type.startsWith("video/") -> 3
                type.startsWith("audio/") -> 4
                type.startsWith("application/pdf") -> 5
                else -> 6
            }
        }

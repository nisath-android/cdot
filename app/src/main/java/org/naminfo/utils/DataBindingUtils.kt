...
import org.naminfo.activities.main.settings.SettingListener
import org.naminfo.activities.voip.data.ConferenceParticipantDeviceData
import org.naminfo.activities.voip.views.ScrollDotsView
import org.naminfo.contact.ContactAvatarGenerator
import org.naminfo.contact.ContactDataInterface
import org.naminfo.contact.getPictureUri
import org.naminfo.views.VoiceRecordProgressBar
...
@BindingAdapter("coilPBXContact")
fun loadContactPictureWithCoil(imageView: ImageView, contact: PBXContactsTable) {
...
private suspend fun loadContactPictureWithCoil(
    ...
    if (contact == null) {
        ...
        val displayName = contact.First_Name.orEmpty()
        val source = contact.First_Name?.substring(0, 2)

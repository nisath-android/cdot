...
import com.naminfo.cdot_vc.activities.main.about.AboutFragment
import com.naminfo.cdot_vc.activities.main.contact.fragments.DetailContactFragment
import com.naminfo.cdot_vc.activities.main.contact.fragments.MasterContactsFragment
import com.naminfo.cdot_vc.activities.main.fragments.TabsFragment
import com.naminfo.cdot_vc.activities.main.history.MasterCallLogsFragment
import com.naminfo.cdot_vc.activities.main.settings.fragments.SettingsFragment
import com.naminfo.cdot_vc.activities.main.sidemenu.fragments.SideMenuFragment
...
internal fun TabsFragment.navigateToContacts() {
    val action = when (findNavController().currentDestination?.id) {
        R.id.dialerFragment -> R.id.action_dialerFragment_to_masterContactsFragment2
        R.id.dialerFragment -> R.id.action_dialerFragment_to_masterCallLogsFragment
...
internal fun MasterCallLogsFragment.navigateToCallHistory(slidingPane: SlidingPaneLayout) {
    if (findNavController().currentDestination?.id == R.id.masterCallLogsFragment) {
        ...
        navHostFragment.navController.navigate(
            R.id.action_global_masterCallLogsFragment,
            null,
...
internal fun AboutFragment.navigateToHelp() {
    findNavController().navigate(

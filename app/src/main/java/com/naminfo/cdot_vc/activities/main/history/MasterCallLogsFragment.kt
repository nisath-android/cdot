...
//import com.naminfo.cdot_vc.activities.clearDisplayedCallHistory
...
import com.naminfo.cdot_vc.activities.main.history.CallLogsListAdapter
import com.naminfo.cdot_vc.activities.main.history.GroupedCallLogData
import com.naminfo.cdot_vc.activities.main.history.CallLogsListViewModel
...
//import com.naminfo.cdot_vc.activities.navigateToConferenceCallHistory
import com.naminfo.cdot_vc.activities.navigateToDialer
import com.naminfo.cdot_vc.databinding.FragmentMasterHistoryBinding
import org.linphone.core.ConferenceInfo
import org.linphone.core.tools.Log
import com.naminfo.cdot_vc.utils.*

class MasterCallLogsFragment : MasterFragment<FragmentMasterHistoryBinding, CallLogsListAdapter>() {
    ...
    override fun getLayoutId(): Int = R.layout.fragment_master_history
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listViewModel.callLogs.observe(
            ...
            // Accessing call details from each GroupedCallLogData
            callLogs?.forEach { callLog ->
                val det = callLog.toString()
                Log.i("Call Logs", "[Call Details],$det")
            }
        }
